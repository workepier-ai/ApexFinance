        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto p-6">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      ...
                      <Button
                        ...
                        className="h-20 bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white flex flex-col items-center justify-center gap-2"
                      >
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <Select value={statusFilter} onValueChange={setStatusFilter}>
                        <SelectTrigger className="w-48 border-gray-300 focus:border-orange-500 focus:ring-orange-500">
            ...
            {!['dashboard', 'new-tenant', 'all-tenants'].includes(activeSection) && (
              <Card className="text-center py-16 hover:shadow-lg transition-all duration-300">
                <CardContent>
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-100 to-orange-200 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Settings className="w-8 h-8 text-orange-600" />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    {navigationItems.flatMap(g => g.items).find(i => i.id === activeSection)?.label} Section
                  </h3>
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    This section is under development. Advanced features for property management will be available here.
                  </p>
                  <Button

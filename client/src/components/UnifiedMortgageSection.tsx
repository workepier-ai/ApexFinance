            ...
            <>
              ...
              <Tabs value={activeView} onValueChange={(value) => setActiveView(value as any)}>
                ...
                <TabsContent value="history" className="mt-0">
                  {/* Custom Cards Section - Side by Side Layout */}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    {/* Left Card - Loan Overview Card (Custom Design) */}
                    <Card className="p-4 bg-white border border-gray-200 rounded-lg">
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Select defaultValue="lifetime">
                              ...
                              <SelectContent>
                                <SelectItem value="lifetime">Lifetime of Loan</SelectItem>
                        ...
                        {/* Main Balance with Principal Paid and Progress Bar */}
                        <div className="space-y-1">
                          <div className="flex items-start justify-between">
                            <div className="flex flex-col">
                              ...
                              <div className="text-sm text-gray-600 mt-1">
                                Original: {formatCurrency(originalBalance)} • {interestRate}% p.a.
                              </div>
                            </div>
                            <div className="flex flex-col items-end">
                              <div className="flex items-center space-x-2 mb-1">
                                ...
                                <span className="text-lg font-semibold text-green-600">
                                  {formatCurrency(originalBalance - outstandingBalance)}
                                </span>
                                <div className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-medium">
                                  {((originalBalance - outstandingBalance) / originalBalance * 100).toFixed(0)}%
                                </div>
                              </div>
                              {/* Small Progress Bar under Principal Paid */}
                              <div className="w-48">
                                <div className="relative h-2 bg-gray-200 rounded-full overflow-hidden">
                                  <div
                                    className="absolute left-0 top-0 h-full bg-green-400 rounded-full"
                                    style={{ width: `${((originalBalance - outstandingBalance) / originalBalance * 100)}%` }}
                                  ></div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="text-center">
                          <div className="text-sm text-gray-600">Total Payments: <span className="font-semibold">$138,766</span></div>
                        </div>

                        {/* Custom Progress Bar with Softer Colors */}
                        <div className="space-y-2">
                          <div className="relative h-6 bg-gray-200 rounded-full overflow-hidden">
                            {/* Green segment - Principal (45%) - Softer green */}
                            <div
                              className="absolute left-0 top-0 h-full rounded-l-full"
                              style={{ width: '45%', backgroundColor: '#86EFAC' }}
                            ></div>
                            {/* Orange segment - Extra Repayment (18%) - Softer orange */}
                            <div
                              className="absolute top-0 h-full"
                              style={{ left: '45%', width: '18%', backgroundColor: '#FDBA74' }}
                            ></div>
                            {/* Purple segment - Interest (37%) - Softer purple */}
                            <div
                              className="absolute right-0 top-0 h-full rounded-r-full"
                              style={{ width: '37%', backgroundColor: '#C4B5FD' }}
                            ></div>
                          </div>

                          {/* Legend with amounts below bubbles */}
                          <div className="grid grid-cols-3 gap-2 text-xs">
                            <div className="text-center">
                              <div className="text-gray-900 px-2 py-1 rounded-full mb-1" style={{ backgroundColor: '#86EFAC' }}>
                                <div className="font-semibold">Principal</div>
                              </div>
                              <div className="font-bold text-gray-900">$62,150.50</div>
                            </div>
                            <div className="text-center">
                              <div className="text-gray-900 px-2 py-1 rounded-full mb-1" style={{ backgroundColor: '#FDBA74' }}>
                                <div className="font-semibold">Extra Repayment</div>
                              </div>
                              <div className="font-bold text-gray-900">$51,615.50</div>
                            </div>
                            <div className="text-center">
                              <div className="text-gray-900 px-2 py-1 rounded-full mb-1" style={{ backgroundColor: '#C4B5FD' }}>
                                <div className="font-semibold">Interest</div>
                              </div>
                              <div className="font-bold text-gray-900">$25,000.00</div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Right Card - Monthly Payment Card (Custom Design) */}
                    <Card className="p-4 bg-white border border-gray-200 rounded-lg">
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="text-right">
                            <div className="text-sm font-semibold text-gray-900">DUE OCT 8</div>
                            <div className="text-xs text-gray-500">{daysUntilDue} days left</div>
                          </div>
                        </div>
                        ...
                        {/* Custom Progress Bar - Matching Softer Colors */}
                        <div className="space-y-2">
                          <div className="relative h-6 bg-gray-200 rounded-full overflow-hidden">
                            {/* Green segment - Principal - Softer green */}
                            <div
                              className="absolute left-0 top-0 h-full rounded-l-full"
                              style={{ width: '45%', backgroundColor: '#86EFAC' }}
                            ></div>
                            {/* Orange segment - Extra Repayment - Softer orange */}
                            <div
                              className="absolute top-0 h-full"
                              style={{ left: '45%', width: '18%', backgroundColor: '#FDBA74' }}
                            ></div>
                            {/* Purple segment - Interest - Softer purple */}
                            <div
                              className="absolute right-0 top-0 h-full rounded-r-full"
                              style={{ width: '37%', backgroundColor: '#C4B5FD' }}
                            ></div>
                          ...
                          {/* Horizontal Pills with amounts below */}
                          <div className="grid grid-cols-3 gap-4">
                            <div className="text-center">
                              <div className="text-gray-900 px-3 py-2 rounded-full mb-1" style={{ backgroundColor: '#86EFAC' }}>
                                <div className="font-semibold text-sm">Principal</div>
                              </div>
                              <div className="font-bold text-sm text-gray-900">$846.77</div>
                            </div>
                            <div className="text-center">
                              <div className="text-gray-900 px-3 py-2 rounded-full mb-1" style={{ backgroundColor: '#FDBA74' }}>
                                <div className="font-semibold text-sm">Extra Repayment</div>
                              </div>
                              <div className="font-bold text-sm text-gray-900">$4,279.53</div>
                            </div>
                            <div className="text-center">
                              <div className="text-gray-900 px-3 py-2 rounded-full mb-1" style={{ backgroundColor: '#C4B5FD' }}>
                                <div className="font-semibold text-sm">Interest</div>
                              </div>
                              <div className="font-bold text-sm text-gray-900">$3,873.70</div>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  {/* Transaction History Table - Below Overview Sections */}
                  <div>
                        ...
                        <table className="w-full">
                          <thead className="bg-gray-50">
                            <tr className="border-b border-gray-200">
                              ...
                              <th className="text-right py-4 px-4 text-sm font-semibold text-gray-700">Principal</th>
                              <th className="text-right py-4 px-4 text-sm font-semibold text-gray-700">Interest</th>
                              <th className="text-right py-4 px-4 text-sm font-semibold text-gray-700">Extra</th>
                              <th className="text-right py-4 px-4 text-sm font-semibold text-gray-700">Balance</th>
                          ...
                          <tbody className="bg-white">
                            {mockPaymentHistory.map((payment, index) => (
                              <tr key={payment.id} className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${
                                ...
                                <td className="py-4 px-4 text-sm font-medium text-gray-900">{payment.date}</td>
                                ...
                                <td className="py-4 px-4 text-right text-sm text-red-600 font-medium">
                                  {formatCurrency(payment.interest)}
                                </td>
                                <td className="py-4 px-4 text-right text-sm text-blue-600 font-medium">
                                ...
                                <td className="py-4 px-4 text-center">
                                  <Badge className={
                                    ...
                                    payment.status === 'SCHEDULED' ? 'bg-blue-100 text-blue-800 border border-blue-200' :
